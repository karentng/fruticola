...
$.fn.storeLocator = function(options) {
  ...
  var settings = $.extend( {
      ...
      'distanceAlert': 60,
      'dataType': 'json',
      'dataLocation': '../../assets/google_maps/results.json',
      'listColor1': 'ffffff',
      'listColor2': 'eeeeee',
      'originMarker': false,
      'originpinColor': 'blue',
      ...
      'infowindowTemplatePath': '../../assets/google_maps/templates/infowindow-description.html',
      'listTemplatePath': '../../assets/google_maps/templates/location-list-description.html',
